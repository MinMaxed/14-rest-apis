...
(function (module) {
  ...
  adminView.initAdminPage = function (ctx, next) {
    ...
    $('#admin-form').on('submit', function(event) {
      ...
      //Doesn't appear to be cleared from local storage. Though localStorage.token = true could be reassigning it if a new token is passed in. I disagree because people can look into local storage and can access it.
